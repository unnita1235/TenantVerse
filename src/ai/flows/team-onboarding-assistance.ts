...
const SuggestRbacRolesInputSchema = z.object({
  ...
  expectedAppUsage: z
    .string()
    .describe('A description of how the app is expected to be used by the team.'),
});
...
export type SuggestRbacRolesOutput = z.infer<typeof SuggestRbacRolesOutputSchema>;

export async function suggestRbacRoles(input: SuggestRbacRolesInput): Promise<SuggestRbacRolesOutput> {
