...
const PersonalizedUserGuideInputSchema = z.object({
  ...
  userRole: z
    .string()
    .describe("The role of the user (e.g., Owner, Admin, Member)."),
  permissionSettings: z
    .string()
    .describe("A description of the permission settings for the user."),
  expectedAppUsage: z
    .string()
    .describe("Description of how the user will use the app"),
});
export type PersonalizedUserGuideInput = z.infer<
  typeof PersonalizedUserGuideInputSchema
>;
...
export type PersonalizedUserGuideOutput = z.infer<
  typeof PersonalizedUserGuideOutputSchema
>;
