    ...
    <div className="space-y-8">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              from {summary?.totalTenants || 0} tenants
            </p>
          </CardContent>
        </Card>
        <Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            A list of all registered organizations.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
                ...
                <TableRow key={tenant.id}>
                  ...
                  <TableCell>
                    {tenant.plan?.charAt(0).toUpperCase() +
                      tenant.plan?.slice(1) || "Free"}
                  </TableCell>
                  <TableCell className="text-right">
                    {tenant.joined
                      ? format(new Date(tenant.joined), "yyyy-MM-dd")
                      : "N/A"}
                  </TableCell>
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          onClick={() =>
                            handleStatusChange(
                              tenant.id,
                              tenant.status === "active" ? "expired" : "active",
                            )
                          }
                        >
